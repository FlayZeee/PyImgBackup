...
if not os.path.exists("settings.json"):
    ...
    json_data = {"directory": f"{homedir}\Pictures\PyImgBackup", "backup_photos": "True", "backup_videos": "False", "search_directories": "Downloads, Pictures, Videos"}
...
def backup_files():
    ...
    for file in vid_files:
        try:
            ...
            duplicate_files += 1
            pass
    pyautogui.alert(text=f"{files_copied} files copied.", title='Backup Complete')
